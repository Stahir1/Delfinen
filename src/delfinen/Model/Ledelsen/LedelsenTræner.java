...
public class LedelsenTræner extends Ledelsen {
    ...
    public void addMembertoTeam(int choiceID) {
        try {
    ...
    public void updateTrainingResults(int choiceSubject, int choiceID, String name, int age, String email, int phoneNumber, String city, int zipCode, String address, boolean competitiveSwimmer, boolean active) {
        try {
    ...
    public void updateTrainingResultsProcess() {
        String name = "";
        int age = 0;
        String email = "";
        int phoneNumber = 0;
    ...
    public void updateEventResults(int choiceSubject, int choiceID, String name, int age, String email, int phoneNumber, String city, int zipCode, String address, boolean competitiveSwimmer, boolean active) {
        try {
    ...
    public void updateEventResultsProcess() {
        String name = "";
        int age = 0;
        String email = "";
        int phoneNumber = 0;
    ...
    public String showTopFive(int choiceID, int choiceSubject) {
        try {
            String query = "";
            Connection myConnector = null;
            PreparedStatement pstmt = null;
    ...
    public void showTopFiveProcess() {
        String name = "";
        int age = 0;
        String email = "";
        int phoneNumber = 0;
